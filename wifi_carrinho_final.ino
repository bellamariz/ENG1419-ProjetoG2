...
#define SSID "Projeto"
#define PASSWORD "2022-11-07"

//SoftwareSerial swSerial(sw_serial_rx_pin, sw_serial_tx_pin);
unsigned long nextPing = 0;
// the last parameter sets the local echo option for the ESP8266 module..
SerialESP8266wifi wifi(Serial3, Serial3, esp8266_reset_pin, Serial);
...
void setup() {
  ...
  wifi.connectToServer("192.168.0.120", "5000");
  //wifi.connectToServer("insecureeducatedconditions.luigigosling.repl.co", "443");
  //wifi.connectToServer("a438-139-82-11-15.ngrok.io", "80");
  String data = String("GET ") + "/" + " HTTP/1.1\r\n" +
                "Host: " + wifi.getIP() + "\r\n" +
                //"ngrok-skip-browser-warning: qualquercoisa\r\n" +
...
//  if (wifi.connectToServer("192.168.0.107", "5000")) {
